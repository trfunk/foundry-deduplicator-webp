# Requires path as argument, writes duplicates to dedup.txt
# dedup.txt: filename,duplicate\n
# Stolen from https://stackoverflow.com/a/36113168 and slightly modified.
